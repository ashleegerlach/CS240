...
public class ContactsDAO {
	...
	private static Logger logger; //log files are used to debug the program. Otherwise you have to attach a debugger to the server.
	...
	public List<Contact> getAll() throws DatabaseException {
		//The DatabaseException is one that Rodham actually made himself
		//Java will naturarlly throw a SQLite Exception, but that might not be such a good idea
		//if you want to use a different type of database ever. 
